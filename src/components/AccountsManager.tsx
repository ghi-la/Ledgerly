...
import { EmptyState, Money, useSettings } from '@/components/ui';
...
/** The accounts list/CRUD UI, extracted so it can be embedded as a Settings section rather than living on its own route. */
      ...
      <Grid container spacing={2}>
        ...
        {(data ?? []).map((a) => (
          <Grid item xs={12} sm={6} md={4} key={a._id}>
            <Card variant="outlined" sx={{ height: '100%', opacity: a.archived ? 0.6 : 1 }}>
              <CardContent>
